...
<!-- Main content -->
    <section class="content">
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="box">
                    <form method="POST"  action="{{route('admin.benefits.store')}}" data-toggle="validator" id="add" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="tabs-content">
                                ...
                                <div class="regulations-content">
                                    ...
                                    <div class="form-group has-feedback">
                                        <div class="form-group">
                                            <label>
                                                <input type="checkbox" name="bonus"> Bonus
                                            </label>
                                        </div>
                                    </div>
                                    <div class="form-group has-feedback">
                                    ...
                                    <div class="form-group has-feedback">
                                        <div class="form-group">
                                            <label>
                                                <input type="checkbox" name="diamond"> Diamond
                                            </label>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="wrap-regulations-content">
                                ...
                                <div class="regulations-content">
                                    ...
                                    <div class="form-group has-feedback">
                                        <label for="title">Название</label>
                                        <input type="text" name="title_ru" class="form-control" id="title" placeholder="Название" value="{{old('title_ru')}}" required>
                                        <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                                    </div>
                                    @error('title_ru')
                                    <div class="alert alert-danger">{{$message}}</div>
                            ...
                            <div class="wrap-regulations-content">
                                ...
                                <div class="regulations-content">
                                    ...
                                    <div class="form-group has-feedback">
                                        <label for="title">Название</label>
                                        <input type="text" name="title_fi" class="form-control" id="title" placeholder="Название фильтра" value="{{old('title_fi')}}" required>
                                        <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                                    </div>
                                    @error('title_fi')
                                    <div class="alert alert-danger">{{$message}}</div>
                            ...
                            <div class="wrap-regulations-content">
                                ...
                                <div class="regulations-content">
                                    ...
                                    <div class="form-group has-feedback">
                                        <label for="title">Название</label>
                                        <input type="text" name="title_et" class="form-control" id="title" placeholder="Название фильтра" value="{{old('title_et')}}" required>
                                        <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                                    </div>
                                    @error('title_et')
                                    <div class="alert alert-danger">{{$message}}</div>
